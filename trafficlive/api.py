...
class StaffEmployee(BaseApi):
    ...
    def get_staff_list(self, window_size=None, current_page=None, filter_by=None, order=None, data_format='json'):
        return super(StaffEmployee, self).get_list(window_size,
                                                   current_page,
                                                   filter_by, order)
...
class StaffDepartment(BaseApi):
    ...
    def get_department_list(self, window_size=None, current_page=None, filter_by=None, order=None, data_format='json'):
        return super(StaffDepartment, self).get_list(window_size,
                                                     current_page,
                                                     filter_by,
                                                     order)
...
class StaffLocation(BaseApi):
    ...
    def get_location_list(self, window_size=None, current_page=None, filter_by=None, order=None, data_format='json'):
        return super(StaffLocation, self).get_list(window_size,
                                                   current_page,
                                                   filter_by,
                                                   order)
...
class JobTaskAllocation(BaseApi):
    url = '/staff/employee'

    def get_by_employee(self, staff_id, window_size=None, current_page=None):
        url = "%s/%s/jobtaskallocations" % (self.url, str(staff_id))
        params = populate_params(window_size=window_size,
